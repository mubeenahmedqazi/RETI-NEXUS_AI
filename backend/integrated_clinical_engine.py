...
if __name__ == "__main__":
    ...
    possible_paths = [
        os.path.join(engine.base_path, 'backend', 'pic1.png'),
        os.path.join(engine.base_path, 'pic1.png'),
        os.path.abspath('pic1.png'),
        os.path.abspath(os.path.join('backend', 'pic1.png'))
    ]
    ...
    if img_path:
        ...
        print(f"[X] CRITICAL: 'pic1.png' target image could not be matched.")
