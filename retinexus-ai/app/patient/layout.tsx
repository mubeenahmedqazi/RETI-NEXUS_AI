...
export default function PatientLayout({
  ...
  // ✅ For register page, render WITHOUT sidebar
  if (isRegisterPage) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#050816] via-[#0a0a1a] to-[#131533]">
        {children}
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#050816] via-[#0a0a1a] to-[#131533] flex flex-col">
      {/* Mobile Menu Button */}
      <AnimatePresence>
