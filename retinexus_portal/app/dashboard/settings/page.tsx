...
import {
  User, Mail, Hospital, Phone, Stethoscope, Sun, Moon,
...
export default function DoctorSettingsPage() {
  ...
  const fields = [
    ...
    { icon: Hospital, label: 'Hospital', value: doctor?.hospital },
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs" style={{ color: 'var(--subtle-foreground)' }}>Get notified when an AI analysis finishes</p>
                </div>
              </div>
              <button
