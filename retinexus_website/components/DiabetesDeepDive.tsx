      ...
      <div className="max-w-5xl mx-auto">
        <ScrollReveal className="max-w-3xl">
          ...
          <p className="mt-4 leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
            ...
            stages — which is exactly why routine screening (not waiting for symptoms) is the only reliable way
            to catch it in time.
          </p>
        </ScrollReveal>
...
const timeline = [
  ...
  },
  {
    ...
    points: [
      ...
      { icon: HeartPulse, organ: 'Heart', text: 'Risk of heart attack is 2–4x higher than in someone without diabetes.' },
